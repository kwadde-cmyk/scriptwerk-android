...
import { electrumHostAllowed, indexerHostAllowed, isPublicIndexerHost, nativeIndexerHostAllowed, parseElectrumUrl, scriptPubKeyFromAddress, scripthashForAddress } from "../electrum.ts";
import {
  applyKeyMaterial,
